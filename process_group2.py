"""
Process and generate YAML answers for Group 2 units:
- CHCCCS031 Part A
- CHCCCS031 Part B
- CHCCCS038
- CHCCCS041
            ...
            for c_idx, c in enumerate(r.cells):
                ...
                for cb_i, cb in enumerate(cb_list):
                    ...
                    if section == "Preliminary Task":
                        ...
                        if any(w in cb_label.lower() for w in ['bruise', 'burn', 'fear', 'withdrawn', 'injury', 'depression', 'anxiety', 'yes', 'tick']):
                            cb_value = True
